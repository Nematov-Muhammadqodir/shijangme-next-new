...
const AddProduct = ({ initialValues, ...props }: any) => {
  ...
  const doDisabledCheck = () => {
    if (
      ...
      insertProductData.productOrigin === "" ||
      insertProductData.productDiscountRate === 0
    ) {
      return true;
    }
  };
  ...
  return (
    <div id="add-product-page">
      <Stack className="main-title-box">
        ...
        <Typography className="sub-title">Add and Update Products!</Typography>
      </Stack>
        ...
        <Stack className="config">
          <Stack className="description-box">
            <Stack className="config-column">
              ...
              <Typography className="title" style={{ marginTop: "20px" }}>
                Product Origin
              </Typography>
              <input
                type="text"
            ...
            <Stack className="config-row">
              <Stack className="price-year-after-price">
                <Typography className="title">Origin Price</Typography>
                <input
                  type="text"
                  className="description-input"
                  placeholder={"Origin Price"}
                  value={insertProductData.productOriginPrice}
                  onChange={({ target: { value } }) =>
                    setInsertProductData({
                      ...insertProductData,
                      productOriginPrice: parseInt(value),
                    })
                  }
                />
              </Stack>
              ...
              <Stack className="price-year-after-price">
                ...
                <input
                  ...
                  onChange={({ target: { value } }) =>
                    setInsertProductData({
                      ...insertProductData,
                      productLeftCount: parseInt(value),
                    })
                  }
                />
              </Stack>
            ...
            <Stack className="config-row">
              <Stack className="price-year-after-price">
                ...
                <select
                  ...
                  defaultValue={insertProductData.productVolume || "select"}
                  value={insertProductData.productVolume || "select"}
                  onChange={({ target: { value } }) =>
                    // @ts-ignore
                    setInsertProductData({
                      ...insertProductData,
                      productVolume: Number(value) as ProductVolume,
                    })
                  }
                >
                  <>
              ...
              <Stack className="price-year-after-price">
                <Typography className="title">Select Collection</Typography>
                <select
                  className={"select-description"}
                  defaultValue={insertProductData.productCollection || "select"}
                  value={insertProductData.productCollection || "select"}
                  onChange={({ target: { value } }) =>
                    // @ts-ignore
                    setInsertProductData({
                      ...insertProductData,
                      productCollection: value as ProductCollection,
                    })
                  }
                >
                  <>
                    ...
                    {productCollection.map((type: any) => (
              ...
              <Stack className="price-year-after-price">
                <Typography className="title">Discount Rate</Typography>
                <input
                  type="text"
                  className="description-input"
                  placeholder={"Origin Price"}
                  value={insertProductData.productDiscountRate}
                  onChange={({ target: { value } }) =>
                    setInsertProductData({
                      ...insertProductData,
                      productDiscountRate: parseInt(value),
                    })
                  }
                />
              </Stack>
